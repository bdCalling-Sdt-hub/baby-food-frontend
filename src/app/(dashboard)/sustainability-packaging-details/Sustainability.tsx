...
const Sustainability = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      price: 4.99,
      description:
        "Nourishing carrot and lentil soup, high in protein and perfect for a hearty baby meal.",
    },
    {
      id: 7,
      key: 7,
      ...
      price: 4.79,
      description:
        "A wholesome oatmeal mixed with fresh blueberries, a fiber-rich breakfast for your little one.",
    },
    {
      id: 8,
      key: 8,
      ...
      price: 4.49,
      description:
        "Creamy yogurt mixed with sweet peaches, perfect for a delicious and nutritious snack.",
    },
  ];
  ...
  return (
    <div>
      ...
      <div className=" flex  items-center justify-between mb-5">
        <DashboardTitle className=""> Sustainability</DashboardTitle>
