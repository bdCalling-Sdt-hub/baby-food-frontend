...
const OtpVerify = () => {  
    ...
    return (
        <div className={` w-full min-h-screen transition-all duration-1000 ease-in-out  pt-[85px] flex  items-center justify-center `}>  
             ...
             <div className='w-1/2'>  
             <p className='text-center pb-4 text-3xl text-[#222222] font-[450]'>Verification code</p>
             <p className="text-center text-[18px] pb-8 text-[#6B6B6B] " > 
             We sent a reset link to email@gmail.com <br />  enter 5 digit code that is mentioned in the email    </p> 
