  ...
  return (
    <div>
      ...
      <p className="mt-5">
        ...
        filled with unnecessary ingredients, when what babies truly require are
        wholesome, organic foods. When we started our baby on solids, we
        struggled to find the right options. That&apos;s when the idea for our
        frozen purée cubes was born.
      </p>
      <p className="mt-5">
