...
const AddBlogModal = ({setOpen , open , modalData ,setModalData  }:propsType) => { 
    ...
    useEffect(()=>{ 
      if(modalData){
        form.setFieldsValue({subtitle:modalData?.subTitle , title:modalData?.title , description:modalData?.description}) 
...
<p className=' pb-3 text-lg font-[500]'> {modalData ? "Update Blog" : "Add Blog"}</p>
...
>
  <Form.Item name="imagess" >
    <div className="flex justify-center items-center w-full h-[100px] ">
      {imageUrl ? (
        <img src={imageUrl} style={{ height:"100px" , width:"100px" , borderRadius:"10px" , objectFit:'contain' ,}} alt="" />
      ) 
       : (
